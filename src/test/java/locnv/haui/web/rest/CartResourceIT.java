...
class CartResourceIT {
    ...
    public static Cart createEntity(EntityManager em) {
        Cart cart = new Cart().userId(DEFAULT_USER_ID).status(DEFAULT_STATUS).createDate(DEFAULT_CREATE_DATE);
        return cart;
    }
    ...
    public static Cart createUpdatedEntity(EntityManager em) {
        Cart cart = new Cart().userId(UPDATED_USER_ID).status(UPDATED_STATUS).createDate(UPDATED_CREATE_DATE);
        return cart;
    }
    ...
    void putNewCart() throws Exception {
        ...
        updatedCart.userId(UPDATED_USER_ID).status(UPDATED_STATUS).createDate(UPDATED_CREATE_DATE);
    ...
    void partialUpdateCartWithPatch() throws Exception {
        ...
        partialUpdatedCart.userId(UPDATED_USER_ID).createDate(UPDATED_CREATE_DATE);
    ...
    void fullUpdateCartWithPatch() throws Exception {
        ...
        partialUpdatedCart.userId(UPDATED_USER_ID).status(UPDATED_STATUS).createDate(UPDATED_CREATE_DATE);
