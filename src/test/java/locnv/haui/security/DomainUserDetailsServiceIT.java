...
class DomainUserDetailsServiceIT {
    ...
    public void init() {
        ...
        userOne.setAddress("userOne");
        userOne.setFullName("doe");
        ...
        userTwo.setAddress("userTwo");
        userTwo.setFullName("doe");
        ...
        userThree.setAddress("userThree");
        userThree.setFullName("doe");
